 ...
 * 基础管道数据流结构
 */
export declare type Pipeline<T = unknown> = {
    /**
 ...
 * 事件类型
 */
export declare type EventLike<T = unknown> = {
    eventName: string;
    detail: T;
};
/**
 ...
 */
export declare class BaseApp<P = unknown, K = unknown> implements Pipeline<P>, Emitter<K> {
    /**
     * 注册的事件列表，用事件名加以管理
     */
