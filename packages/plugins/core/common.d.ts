...
export declare const transformerPath = "../../transformer/dist/octopus-transformer.cjs.js";
export declare const sharedPath = "./octopus/shared";
export declare const transporterPath = "./octopus/transporter";
