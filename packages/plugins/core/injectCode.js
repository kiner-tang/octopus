...
exports.injectLibFiles = exports.helpers = exports.getFunctionStr = exports.injectLibInWxApi = exports.createWxModuleSourceFragment = exports.apiProxyEntry = exports.apiProxySourceList = exports.createExportObjectSource = void 0;
 ...
 * api 代理入口代码
 */
exports.apiProxyEntry = "\n  exports.destroyProxyApi = (function(){\n    ".concat(Object.keys(exports.apiProxySourceList).map(function (api) {
 ...
 * @returns
 */
function createWxModuleSourceFragment(core, exportSources, helpers, apiProxyEntry) {
    if (exportSources === void 0) { exportSources = {}; }
    if (helpers === void 0) { helpers = {}; }
    if (apiProxyEntry === void 0) { apiProxyEntry = ""; }
    return fragment
        ...
        .replace(common_1.apiProxySymbol, apiProxyEntry);
}
...
function createLibSource(config) {
    return createWxModuleSourceFragment(exports.injectLibInWxApi, initExportSources(config), exports.helpers, exports.apiProxyEntry);
}
/**
 * 需要注入的库文件
 */
