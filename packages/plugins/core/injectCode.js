...
exports.injectLibFiles = exports.helpers = exports.getFunctionStr = exports.injectLibInWxApi = exports.createWxModuleSourceFragment = exports.apiProxyEntry = exports.apiProxyList = exports.apiProxySourceList = exports.createExportObjectSource = void 0;
 ...
 * @returns
 */
function createWxModuleSourceFragment(core, exportSources, helpers, apiProxyEntryStr) {
...
function createLibSource(config) {
    return createWxModuleSourceFragment(exports.injectLibInWxApi, initExportSources(config), exports.helpers, apiProxyEntry());
}
/**
 * 需要注入的库文件
 */
