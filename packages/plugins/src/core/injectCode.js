...
function createExportObjectSource(exportSources) {
    return Object.keys(exportSources)
        .map(function (name) {
        return "exports." + name + " = " + (typeof exportSources[name] === 'string' ? exportSources[name] : JSON.stringify(exportSources[name]));
    })
        .join('\n');
}
...
function apiProxyEntry() {
    return "\n  exports.destroyProxyApi = (function(){\n    " + exports.apiProxyList
        .map(function (api) {
        return "var " + api + " = (" + exports.apiProxySourceList[api] + ")()";
    })
        .join('\n') + "\n    return function destroy() {\n      " + exports.apiProxyList
        .map(function (api) {
        return api + "()";
...
var depsSource = function () {
    return __spreadArray([
        injectDeps(_1.transformerPath, fs_1.readFileSync(path_1.resolve(__dirname, _1.transformerPath), 'utf-8')),
        injectDeps(_1.transporterPath, fs_1.readFileSync(path_1.resolve(__dirname, _1.transporterPath), 'utf-8'))
...
function createWxModuleSourceFragment(core, exportSources, helpers, apiProxyEntryStr, performanceStr) {
    ...
    return fragment
        ...
        .replace(_1.injectDepsSymbol, exports.depsSource())
...
exports.injectWxss = "\n." + common_1.octopusActiveElemSelector + " {\n  box-shadow: 0 0 10px #333;\n}\n";
/**
 * 生成库文件代码
 * @returns
 */
